...
struct cpu
{
    ...
    static void set_gdtr(global_descriptor_table<1> *gdt, unsigned short entry_count);
...
inline void cpu::set_gdtr(global_descriptor_table<1> *gdt, unsigned short entry_count)
{
